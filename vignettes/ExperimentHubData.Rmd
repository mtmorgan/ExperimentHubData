...
created with the same name as the package. The author will be given access to 
the bucket; confirm access and username by writing to 
maintainer@bioconductor.org. To upload data you need an active
AWS account and need to install the command line interface (AWS CLI) tool.
Upload the data using this command:
